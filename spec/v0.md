# Inactu Composable Skills Spec (v0)

This document defines the normative v0 contract for secure, deterministic,
host-mediated skill composition in Inactu.

## 1. Goals

Inactu v0 MUST provide:
...
- Node `skill` references MAY be symbolic names or exact-hash refs
  (`sha256:<hash>`), including pinned objects carrying optional source metadata.
